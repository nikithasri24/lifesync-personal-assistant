              ...
              <div className="flex items-center gap-2">
                {isAchieved ? (
                  <button
                    ...
                    disabled={isUpdating}
                    className="inline-flex items-center gap-1 rounded-full bg-orange-50 px-3 py-1 text-xs font-medium text-orange-600 transition hover:bg-orange-100 disabled:opacity-50"
