...
export function useCreateProjectMutation() {
  ...
  return useMutation({
    ...
    onError: (err, variables, context) => {
      ...
      console.error('[useCreateProjectMutation] Error creating project:', err);
    },
...
export function useUpdateProjectMutation() {
  ...
  return useMutation({
    ...
    onError: (err, variables, context) => {
      ...
      console.error('[useUpdateProjectMutation] Error updating project:', err);
    },
...
export function useDeleteProjectMutation() {
  ...
  return useMutation({
    ...
    onError: (err, projectId, context) => {
      ...
      console.error('[useDeleteProjectMutation] Error deleting project:', err);
    },
    onSuccess: () => {
