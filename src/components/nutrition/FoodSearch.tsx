...
export function FoodSearch({ onSelectFood, onClose }: FoodSearchProps): React.ReactElement {
  ...
  const mergedResults = useMemo(() => {
    ...
    const mappedCustomFoods: NutritionInfo[] = customFoods.map((food) => ({
      name: food.name,
      brand: food.brand,
      ...
      proteinPer100g: food.protein_g,
      carbsPer100g: food.carbs_g,
      fatPer100g: food.fat_g,
      fiberPer100g: food.fiber_g,
      sugarPer100g: food.sugar_g,
    }));
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-xs text-orange-600 font-medium">{Math.round(product.caloriesPer100g)} cal/100g</span>
