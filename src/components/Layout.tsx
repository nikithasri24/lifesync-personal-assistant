  ...
  return (
    <div className="h-screen flex" style={{ backgroundColor: colors.bg.primary }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {!isDesktop && activeView !== 'together' && activeView !== 'notes' && activeView !== 'journal' && activeView !== 'habits' && activeView !== 'lifegoals' && activeView !== 'todos' && activeView !== 'shopping' && activeView !== 'meals' && activeView !== 'assistant' && activeView !== 'calendar' && activeView !== 'travel' && activeView !== 'nutrition' && activeView !== 'self-care' && activeView !== 'focus' && (
          <header
