-- Fix RLS policies for user_passports and user_visas
-- This ensures the policies are correctly set up for both personal and merged mode

-- ==================== Fix user_passports RLS Policies ====================
