...
import { deleteMealPlanHandler, deletePlannedMealHandler, getMealPlanForWeek, getMealPlans, postMealPlan, postPlannedMeal, putMealPlan, putPlannedMeal } from './meal.controller.js'
...
mealRouter.get('/meal-plans/for-week', getMealPlanForWeek)
